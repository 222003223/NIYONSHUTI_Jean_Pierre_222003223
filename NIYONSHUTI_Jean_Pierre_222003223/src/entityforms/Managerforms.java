...
public class Managerforms implements ActionListener{
	JFrame frame;
				...
				private void setLocationandSize() {
					...
					cl_lb.setBounds(10, 210, 100, 30);
					//user_lb.setBounds(10, 250, 100, 30);
					...
					cl_txf.setBounds(160, 210, 130, 30);
					//user_txf.setBounds(160, 250, 130, 30);
			  //Buttons CRUD
			   ...
			   public void actionPerformed(ActionEvent e) {
					...
					if(e.getSource()==insert_btn) {
						...
						pl.setClub_id(cl_txf.getText());
						pl.insertData();
					}else if (e.getSource()==Read_btn) {
						int id=Integer.parseInt(id_txf.getText());
						pl.readWithID(id);
						id_txf.setText(String.valueOf(pl.getManager_id()));
						...
						cl_txf.setText(pl.getClub_id());
						//user_txf.setText(pl.getUser_id());
						...
						pl.setContact(cont_txf.getText());
						pl.setClub_id(cl_txf.getText());
						//pl.setUser_id(user_txf.getText());
						pl.update(id);
					}else {
						int id=Integer.parseInt(id_txf.getText());
						pl.delete(id);
				...
				Managerforms  managersform= new Managerforms();
				System.out.println(managersform);
				}}
